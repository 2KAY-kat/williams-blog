import{B as c,s as i}from"./utils-CTkCsTWQ.js";import"./index-CsxmzJuP.js";import"./auth-check-CYKU-M1L.js";const d=6;let u=0,n=!0,l=[];document.addEventListener("DOMContentLoaded",()=>{p(),h()});function h(){const e=document.getElementById("load-more-button");e&&e.addEventListener("click",y)}function f(e){const t=document.getElementById("featured-story-container");if(!e){t.innerHTML='<p class="loading-featured">No featured story available.</p>';return}let a="https://placehold.co/800x400/222222/DDDDDD?text=Featured+Story";e.main_image_url&&(a=c+e.main_image_url);const s=e.categories&&e.categories.length>0?e.categories[0]:"General",r=new Date(e.created_at).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),o=e.content_preview||"Discover what's new in this featured article.";t.innerHTML=`
