import{B as n,s as l}from"./utils-CTkCsTWQ.js";import"./index-ClKxXFVO.js";import"./auth-check-CYKU-M1L.js";const d=7;let u=0,o=!0,c=[];document.addEventListener("DOMContentLoaded",()=>{h(),p()});function p(){const e=document.getElementById("load-more-button");e&&e.addEventListener("click",y)}function f(e){const t=document.getElementById("featured-story-container");if(!e){t.innerHTML='<p class="loading-featured">No featured story available.</p>';return}let a=`${n}/uploads/placeholder.png`;e.main_image_url&&(a=n+e.main_image_url);const r=e.categories&&e.categories.length>0?e.categories[0]:"General",s=new Date(e.created_at).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),i=e.content_preview||"Discover what's new in this featured article.";t.innerHTML=`
